...
public class Paytm {
    ...
    private String p2pTransferUrl = "https://trust-uat.paytm.in/wallet-web/wrapper/p2pTransfer";

    private String clientId = "staging-grofers";
    ...
    public JSONObject getP2pTransferBody(int isToVerify, int isLimitApplicable, String payeeEmail,
                                   String payeeMobile, String payeeCustId, int amount,
        ...
        try {
            ...
            request.put("payeeEmail", payeeEmail);
            request.put("payeeMobile", payeeMobile);
            request.put("payeeCustId", payeeCustId);
